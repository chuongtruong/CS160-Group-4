...
export const Navbar = ({orderNum,id,setIsCart}) => {
  ...
  return (
      <nav id="navbar" className="global-nav w-full h-20">
              <ul className="global-nav-links w-1/2 h-full mx-auto flex items-center">
                  ...
                  <li className="nav-ele ml-10 cursor-pointer w-20 h-8 px-3 py-1 rounded-full bg-red-500 flex justify-between" onClick={()=>navigate(`/cart`)}>
                    <a>
